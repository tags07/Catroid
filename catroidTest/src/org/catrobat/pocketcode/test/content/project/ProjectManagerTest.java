 ...
 */
package org.catrobat.pocketcode.test.content.project;
...
public class ProjectManagerTest extends InstrumentationTestCase {
	...
	public Project createTestProject(String projectName) throws IOException {
		...
		File image = TestUtils.saveFileToProject(projectName, "image.png", org.catrobat.pocketcode.test.R.raw.icon,
