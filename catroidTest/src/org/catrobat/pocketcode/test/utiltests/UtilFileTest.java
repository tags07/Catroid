...
public class UtilFileTest extends InstrumentationTestCase {
	...
	private String catroidDirectory = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Pocket Code";
	...
	public void testFileSize() throws IOException {
		for (int i = 0; i < 2; i++) {
			UtilFile.saveFileToProject("testDirectory", i + "testsound.mp3",
					org.catrobat.pocketcode.test.R.raw.longtestsound, getInstrumentation().getContext(),
