 ...
 */
package org.catrobat.pocketcode.uitest.ui.fragment;
...
public class LookFragmentTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {
	...
	private static final int RESOURCE_IMAGE3 = org.catrobat.pocketcode.uitest.R.drawable.catroid_sunglasses_jpg;
	...
	public void testGetImageFromGallery() {
		...
		Intent intent = new Intent(getInstrumentation().getContext(),
				org.catrobat.pocketcode.uitest.mockups.MockGalleryActivity.class);
	...
	public void testGetImageFromPaintroid() {
		...
		Intent intent = new Intent(getInstrumentation().getContext(),
				org.catrobat.pocketcode.uitest.mockups.MockPaintroidActivity.class);
